...
document.querySelectorAll('.filter-btn').forEach(button => {
    button.addEventListener('click', () => {
      ...
      // Show/hide skills based on the selected category
...
//this for filtering skills when we have a tablette or smartphone
document.querySelectorAll('.filter-btn-dropdown').forEach(button => {
    button.addEventListener('click', () => {
      // Remove active class from all buttons
      document.querySelectorAll('.filter-btn-dropdown').forEach(btn => btn.classList.remove('active'));
